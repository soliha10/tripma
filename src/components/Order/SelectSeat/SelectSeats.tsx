        ...
        <div className="flex overflow-hidden h-screen  ">
          ...
          <div className="w-full overflow-y-auto h-full scrollbar-hide ">
            ...
            <div className="w-full overflow-hidden relative ">
              <Image src={bgPlane} alt="plane" className="relative left-[-310px] " />
              <SeatMap
            ...
            <div className="bg-[#27273F] text-[#FAFAFA] flex items-center ">
              ...
              <div
                ...
                className={`py-5 px-6 flex flex-col w-[210px]  ${
                  selectTab === 'depart' ? 'bg-[#605DEC] relative' : 'bg-transparent'
                } `}
              >
                <time>Feb 25 | 7:00AM</time>
                <span className="text-xs">Departing</span>
                {selectTab === 'depart' && (
                  <Image src={chevron} alt="pic" className="absolute bottom-0 left-[45%] " />
                )}
              </div>
              ...
              <div
                ...
                className={`py-5 px-6 flex flex-col w-[210px]  ${
                  selectTab === 'return' ? 'bg-[#605DEC] relative' : 'bg-transparent'
                } `}
              >
              ...
              <div className="pt-8 w-[335px] ">
                ...
                <div className="pt-4 px-8 pb-8 ">
                  <div className="flex items-center gap-4 mb-4">
                    <h3 className="text-[#6E7491] text-[18px] font-semibold ">Economy</h3>
                    <span
                      className="w-[69px] py-1 inline-block font-bold text-white text-[14px] text-center rounded "
                      style={{
                        backgroundImage: 'linear-gradient(180deg, #605DEC 0%, #2A26D9 100%)',
                      }}
                    >
                      Selected
                    </span>
