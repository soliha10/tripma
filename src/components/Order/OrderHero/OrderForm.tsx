...
export default function OrderForm({
  ...
  return (
    <div className="lg:w-[682px]">
      <h2 className="text-[#6E7491] text-[18px] font-semibold mb-6 ">Passenger 1 (Adult)</h2>
      <form action="">
        <div className="flex flex-wrap gap-6 mb-6">
          ...
          <div className="flex flex-col gap-[6px]">
            ...
            <span className="text-xs inline-block ms-1 text-[#7C8DB0]">MM/DD/YY</span>
          </div>
        </div>
      ...
      <form action="">
        <Label className="mb-[28px] ">
          <Input type="checkbox" className="w-4 h-4" onClick={() => setIsChecked(true)} />
      ...
      <h2 className="text-[#6E7491] text-[18px] font-semibold mb-[11px]">Bag information</h2>
      ...
      <div className="flex items-center justify-start gap-6 ">
        ...
        <Button
          ...
          disabled={!(firstName && lastName && birthDate && email && phoneNumber)}
          type="button"
