          ...
          <div className="max-w-[1342px]  w-full mx-auto px-5 ">
            <div className="flex justify-between">
              ...
              <div className="w-[756px]">
                ...
                <h1 className="text-[#605DEC] text-2xl font-bold mb-4 ">Bon voyage, Sophia!</h1>
                ...
                <h2 className="text-[#6E7491] text-2xl font-bold mb-4 ">Flight summary</h2>
                ...
                <h2 className="text-[#6E7491] text-2xl font-bold mb-4 ">Payment method</h2>
                <div
                  className="rounded-2xl mb-14 w-[300px] pt-7 px-6 pb-6 text-[#F6F6FE]  font-semibold "
                  style={{
                    backgroundImage: 'linear-gradient(180deg, #EB568C 0%, #ED5E76 100%)',
                    boxShadow:
                ...
                >
                  ...
                  <strong className="inline-block mb-2 text-[18px] ">Sophia Knowles</strong>
                ...
                <form action="" className="w-[400px] mb-14 flex flex-col gap-6  ">
                  <Input
                  ...
                  <div>
                    ...
                    <Button className="w-[133px] text-[#605DEC] text-[18px] ">Add another</Button>
                  </div>
                </form>

                <h2 className="text-[#6E7491] text-2xl font-bold mb-6 ">Flight Route</h2>
                <Image src={map} alt="" />
              </div>
